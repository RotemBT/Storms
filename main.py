...
def crawling_table():
    ...
    for url in all_url:
        ...
        tdOfStorm = bs.find_all('td',
                                {'class': 'mat-cell cdk-cell cdk-column-storms mat-column-storms ng-star-inserted'})
        tdOHurricanes = bs.find_all('td', {
            'class': 'mat-cell cdk-cell cdk-column-hurricanes mat-column-hurricanes ng-star-inserted'})
        tdOfDeaths = bs.find_all('td',
                                 {'class': 'mat-cell cdk-cell cdk-column-deaths mat-column-deaths ng-star-inserted'})
        ...
        for td in tdOfYear:
            ...
            # storms_names.append(td.find('a')['href'])
        for td in tdOfStorm:
